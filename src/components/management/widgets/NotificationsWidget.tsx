    ...
    >
      {notifications.length === 0 ? (
        <EmptyState
          ...
          description={
            language === "FR"
              ? "Les alertes de prix, trades et ventes apparaitront ici."
              : "Price alerts, trades and sales notifications will appear here."
          }
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-5 text-white/52">{notification.message}</p>
                  </div>
                </div>
                {!notification.isRead ? (
                  <button
